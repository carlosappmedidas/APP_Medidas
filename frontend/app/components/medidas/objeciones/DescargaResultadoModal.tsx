// Modal de resumen post-ejecución — muestra {importados, reemplazados, errores, detalle[]}.
// FASE 5 · Sub-paso 5.3.

"use client";

import type { EjecutarResponse } from "./shared/types";

interface DescargaResultadoModalProps {
  open:        boolean;
...
export default function DescargaResultadoModal({ open, resultado, onClose }: DescargaResultadoModalProps) {
