...
// FASE 5 · Sub-paso 5.3 (spec V8 · puntos 24-25).

"use client";

import type { BusquedaResult } from "./shared/types";

interface DescargaConfirmReemplazoModalProps {
  open:            boolean;
...
}: DescargaConfirmReemplazoModalProps) {
  if (!open) return null;
      ...
      >
        ...
        <div style={{ padding: "14px 20px", overflowY: "auto", flex: 1 }}>
          ...
          <div style={{
            ...
            <strong>Importante:</strong> esto <u>borrará todas las respuestas guardadas</u> en la versión antigua (aceptaciones, motivos, comentarios). Esta acción no se puede deshacer.
          </div>
