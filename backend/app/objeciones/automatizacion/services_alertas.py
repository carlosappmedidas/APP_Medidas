...
def upsert_alerta(
    ...
    *,
    ...
    if alerta is None:
        ...
        # Si la alerta ya existe en estado "resuelta" o "descartada",
        # NO la reactivamos ni actualizamos sus datos contextuales.
        # El usuario decidió que esa alerta queda gestionada — el rastro
        # (num_pendientes, detalle_json, resuelta_at) queda congelado.
        # Para reactivarla manualmente se hará desde la pantalla de
        # gestión de alertas (Fase 2).
