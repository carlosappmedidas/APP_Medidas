# app/measures/contrib_models/m1.py
...
class M1PeriodContribution(Base):
    """
    Guarda contribuciones de facturación M1 por periodo (año/mes) y por fichero
    de ingestion, para evitar duplicidades y permitir control de refacturas.
