...
from app.tenants.router.ui_table_settings import router as ui_table_settings_router
from app.tenants.router.ui_topologia_settings import router as ui_topologia_settings_router
...
router.include_router(ui_table_settings_router)
router.include_router(ui_topologia_settings_router)
